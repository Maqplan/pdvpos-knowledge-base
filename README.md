...
| Documento | Descrição |
|-----------|-----------|
| [ABOUT](ABOUT.md) | Sobre o projeto e propósito da documentação |
| [VISION](VISION.md) | Visão estratégica do produto |
| [PRINCIPLES](PRINCIPLES.md) | Princípios e filosofia do desenvolvimento |
| [README](README.md) | Página inicial da documentação |
...
| [04 - Gestão de Usuários e Permissões](docs/01-FUNCTIONAL-MODULES/04-GESTAO-DE-USUARIOS-E-PERMISSOES.md) | Perfis, usuários e controle de acesso |
| [05 - Gestão de Clientes](docs/01-FUNCTIONAL-MODULES/05-GESTAO-DE-CLIENTES.md) | Cadastro e relacionamento com clientes |
| [06 - Gestão de Produtos e Serviços](docs/01-FUNCTIONAL-MODULES/06-GESTAO-DE-PRODUTOS-E-SERVICOS.md) | Produtos, serviços, grades, preços e estoque |
| [07 - Gestão de Estoque](docs/01-FUNCTIONAL-MODULES/07-GESTAO-DE-ESTOQUE.md) | Estoque, inventário, transferências e depósitos |
| [08 - Gestão de Compras](docs/01-FUNCTIONAL-MODULES/08-GESTAO-DE-COMPRAS.md) | Compras e entrada de mercadorias |
| [09 - Gestão Comercial e Vendas](docs/01-FUNCTIONAL-MODULES/09-GESTAO-COMERCIAL-E-VENDAS.md) | Pedidos, vendas e integração com PDVs |
